...
public class MListadoCategorias extends MListados {
	...
	public void ActualizaTabla(Listado padre, Vector<String> nombres, Vector<Vector> data) {
		...
		padre.Tabla.getColumnModel().getColumn(0).setPreferredWidth(75);
		padre.Tabla.getColumnModel().getColumn(1).setPreferredWidth(150);
